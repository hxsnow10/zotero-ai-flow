...
def main(args):
    ...
    # 获取向量
    vectors = get_text_vec_aliyun(texts, dimensions=args.dimensions, model=args.model)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-m", "--model", default="text-embedding-v3", type=str, help="使用的模型名称"
    )
